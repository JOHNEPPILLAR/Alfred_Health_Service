...
exports.callAlfredServicePut = function FnCallAlfredServicePut(apiURL, body) {
...
exports.callAlfredServiceGet = function FnCallAlfredServiceGet(apiURL) {
  callAlfredServiceGett(apiURL);
};
